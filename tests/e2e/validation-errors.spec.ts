...
test('shows validation errors and blocks publish for invalid drafts', async ({ page }) => {
  ...
  await expect(page.getByLabel('Card editor panel').getByText('Title is required.').first()).toBeVisible();
